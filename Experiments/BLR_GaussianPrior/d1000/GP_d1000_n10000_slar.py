...
r2scores_bk_d1000_n10000_slar = []
perCorrect_bk_d1000_n10000_slar = []
distances_bk_d1000_n10000_slar = []
convergence_bk_d1000_n10000_slar = []

r2scores_bps_d1000_n10000_slar = []
perCorrect_bps_d1000_n10000_slar = []
distances_bps_d1000_n10000_slar = []
convergence_bps_d1000_n10000_slar = []

r2scores_hmc_d1000_n10000_slar = []
perCorrect_hmc_d1000_n10000_slar = []
distances_hmc_d1000_n10000_slar = []
convergence_hmc_d1000_n10000_slar = []

r2scores_zz_d1000_n10000_slar = []
perCorrect_zz_d1000_n10000_slar = []
distances_zz_d1000_n10000_slar = []
convergence_zz_d1000_n10000_slar = []
...
for i in range(10):
    ...
    "lar noise SNR = 10"
    SNR = 30
    sigma_lar = true_y_d1000_n10000.var(0) / SNR
    y_d1000_n10000_slar = true_y_d1000_n10000 + torch.normal(0, sigma_lar, size = (1, sample_size))


    "Tune model"
    errors = y_d1000_n10000_slar.transpose(0,-1) - torch.matmul(data_d1000_n10000,torch.matmul(torch.matmul(torch.inverse(torch.matmul(data_d1000_n10000.transpose(0,-1), data_d1000_n10000)), data_d1000_n10000.transpose(0,-1)), y_d1000_n10000_slar.transpose(0,-1)))
    sigma = torch.sqrt(torch.mean(errors**2)) #MLE estimation of noise
    labels = y_d1000_n10000_slar
    ...
    bk_d1000_n10000_slar = Boomerang(model, Sigma=Sigma_ref, hessian_bound = hessian_bound, refresh_rate = 10, ihpp_sampler = 'Exact')
    mcmc_bk_d1000_n10000_slar = MCMC(bk_d1000_n10000_slar, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_bk_d1000_n10000_slar.run(data_d1000_n10000)
    "posterior distribution"
    postMean_bk_d1000_n10000_slar = mcmc_bk_d1000_n10000_slar.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_bk_d1000_n10000_slar = mcmc_bk_d1000_n10000_slar.get_samples()['beta']
    print("bk distance", torch.norm(postMean_bk_d1000_n10000_slar - truePost.transpose(0,-1)))
    ...
    print("bk percentage", percentage_correct(predLower_bk_d1000_n10000_slar,predUpper_bk_d1000_n10000_slar,true_y_d1000_n10000))

    "Scores"
    r2scores_bk_d1000_n10000_slar.append(r2_score(labels.squeeze(), predMean_bk_d1000_n10000_slar))
    perCorrect_bk_d1000_n10000_slar.append(percentage_correct(predLower_bk_d1000_n10000_slar,predUpper_bk_d1000_n10000_slar,true_y_d1000_n10000))
    distances_bk_d1000_n10000_slar.append(torch.norm(postMean_bk_d1000_n10000_slar - truePost.transpose(0,-1)))

    "Convergences"
    #k_bk_d1000_n10000_slar = kernel_Stein_Discrepancies(bk_d1000_n10000_slar, postSamp_bk_d1000_n10000_slar)
    #convergence_bk_d1000_n10000_slar.append(k_bk_d1000_n10000_slar)

    #######################################BPS########################################################
    "DEFINITION OF SAMPLER"
    bps_d1000_n10000_slar = BPS(model, dimension=dim, hessian_bound = hessian_bound, refresh_rate = 10, ihpp_sampler = 'Exact')
    mcmc_bps_d1000_n10000_slar = MCMC(bps_d1000_n10000_slar, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_bps_d1000_n10000_slar.run(data_d1000_n10000)
    "posterior distribution"
    postMean_bps_d1000_n10000_slar = mcmc_bps_d1000_n10000_slar.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_bps_d1000_n10000_slar = mcmc_bps_d1000_n10000_slar.get_samples()['beta']
    print("bps distance", torch.norm(postMean_bps_d1000_n10000_slar - truePost.transpose(0, -1)))
    ...
    print("bps r2", r2_score(labels.squeeze(), predMean_bps_d1000_n10000_slar))
    print("bps percentage", percentage_correct(predLower_bps_d1000_n10000_slar,predUpper_bps_d1000_n10000_slar,true_y_d1000_n10000))
    "r2 score"
    r2scores_bps_d1000_n10000_slar.append(r2_score(labels.squeeze(), predMean_bps_d1000_n10000_slar))
    perCorrect_bps_d1000_n10000_slar.append(percentage_correct(predLower_bps_d1000_n10000_slar,predUpper_bps_d1000_n10000_slar,true_y_d1000_n10000))
    distances_bps_d1000_n10000_slar.append(torch.norm(postMean_bps_d1000_n10000_slar - truePost.transpose(0,-1)))

    "Convergences"
    #ksd_bps_d1000_n10000_slar = kernel_Stein_Discrepancies(bps_d1000_n10000_slar, postSamp_bps_d1000_n10000_slar)
    #convergence_bps_d1000_n10000_slar.append(ksd_bps_d1000_n10000_slar)
    #######################################ZZ########################################################
    "DEFINITION OF SAMPLER"
    zz_d1000_n10000_slar = ZZ(model, dimension=dim, Q = Target_sigma_inv, excess_rate = 1, ihpp_sampler = 'Exact')
    mcmc_zz_d1000_n10000_slar = MCMC(zz_d1000_n10000_slar, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_zz_d1000_n10000_slar.run(data_d1000_n10000)
    "posterior distribution"
    postMean_zz_d1000_n10000_slar = mcmc_zz_d1000_n10000_slar.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_zz_d1000_n10000_slar = mcmc_zz_d1000_n10000_slar.get_samples()['beta']
    print("zz distance", torch.norm(postMean_zz_d1000_n10000_slar - truePost.transpose(0,-1)))
    ...
    print("zz percentage", percentage_correct(predLower_zz_d1000_n10000_slar,predUpper_zz_d1000_n10000_slar,true_y_d1000_n10000))
    "r2 score"
    r2scores_zz_d1000_n10000_slar.append(r2_score(labels.squeeze(), predMean_zz_d1000_n10000_slar))
    perCorrect_zz_d1000_n10000_slar.append(percentage_correct(predLower_zz_d1000_n10000_slar,predUpper_zz_d1000_n10000_slar,true_y_d1000_n10000))
    distances_zz_d1000_n10000_slar.append(torch.norm(postMean_zz_d1000_n10000_slar - truePost.transpose(0,-1)))

    "Convergences"
    #ksd_zz_d1000_n10000_slar = kernel_Stein_Discrepancies(zz_d1000_n10000_slar, postSamp_zz_d1000_n10000_slar)
    #convergence_zz_d1000_n10000_slar.append(ksd_zz_d1000_n10000_slar)
    #######################################HMC########################################################
    "DEFINITION OF SAMPLER"
    hmc_d1000_n10000_slar = NUTS(model)
    mcmc_hmc_d1000_n10000_slar = MCMC(hmc_d1000_n10000_slar, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_hmc_d1000_n10000_slar.run(data_d1000_n10000)
    "posterior distribution"
    postMean_hmc_d1000_n10000_slar = mcmc_hmc_d1000_n10000_slar.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_hmc_d1000_n10000_slar = mcmc_hmc_d1000_n10000_slar.get_samples()['beta']
    print("hmc distance", torch.norm(postMean_hmc_d1000_n10000_slar - truePost.transpose(0, -1)))
    ...
    print("hmc percentage", percentage_correct(predLower_hmc_d1000_n10000_slar,predUpper_hmc_d1000_n10000_slar,true_y_d1000_n10000))
    "r2 score"
    r2scores_hmc_d1000_n10000_slar.append(r2_score(labels.squeeze(), predMean_hmc_d1000_n10000_slar))
    perCorrect_hmc_d1000_n10000_slar.append(percentage_correct(predLower_hmc_d1000_n10000_slar,predUpper_hmc_d1000_n10000_slar,true_y_d1000_n10000))
    distances_hmc_d1000_n10000_slar.append(torch.norm(postMean_hmc_d1000_n10000_slar - truePost.transpose(0,-1)))

    "Convergences"
    #ksd_hmc_d1000_n10000_slar = kernel_Stein_Discrepancies(hmc_d1000_n10000_slar, postSamp_hmc_d1000_n10000_slar)
    #convergence_hmc_d1000_n10000_slar.append(ksd_hmc_d1000_n10000_slar)

"to pandas bk"
r2scores_bk_d1000_n10000_slar_df = pd.DataFrame(r2scores_bk_d1000_n10000_slar)
