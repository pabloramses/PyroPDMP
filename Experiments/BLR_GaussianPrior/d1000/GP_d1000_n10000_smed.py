...
for i in range(10):
    ...
    postSamp_hmc_d1000_n10000_smed_df.to_csv(
        PATH + "/results/d1000_n10000_smed/postSamp_hmc_d1000_n10000_smed_run" + str(i) + ".csv")
    "summary of predictions"
    predMean_hmc_d1000_n10000_smed, predLower_hmc_d1000_n10000_smed, predUpper_hmc_d1000_n10000_smed = predictive_summary(
        predSamp_hmc_d1000_n10000_smed, 0.025)
    print("hmc r2", r2_score(labels.squeeze(), predMean_hmc_d1000_n10000_smed))
    print("hmc percentage",
          percentage_correct(predLower_hmc_d1000_n10000_smed, predUpper_hmc_d1000_n10000_smed, true_y_d1000_n10000))
    "r2 score"
    r2scores_hmc_d1000_n10000_smed.append(r2_score(labels.squeeze(), predMean_hmc_d1000_n10000_smed))
    perCorrect_hmc_d1000_n10000_smed.append(
        percentage_correct(predLower_hmc_d1000_n10000_smed, predUpper_hmc_d1000_n10000_smed, true_y_d1000_n10000))
    ...
    postSamp_bps_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/postSamp_bps_d1000_n10000_smed_run" + str(i) + ".csv")
    ...
    postSamp_zz_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/postSamp_zz_d1000_n10000_smed_run" + str(i) + ".csv")
    "summary of predictions"
...
"to csv bps"
r2scores_bps_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/r2scores_bps_d1000_n10000_smed.csv")
perCorrect_bps_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/perCorrect_bps_d1000_n10000_smed.csv")
distances_bps_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/distances_bps_d1000_n10000_smed.csv")
...
"to csv bps"
r2scores_zz_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/r2scores_zz_d1000_n10000_smed.csv")
perCorrect_zz_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/perCorrect_zz_d1000_n10000_smed.csv")
distances_zz_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/distances_zz_d1000_n10000_smed.csv")
...
"to csv bps"
r2scores_hmc_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/r2scores_hmc_d1000_n10000_smed.csv")
perCorrect_hmc_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/perCorrect_hmc_d1000_n10000_smed.csv")
distances_hmc_d1000_n10000_smed_df.to_csv(PATH + "/results/d1000_n10000_smed/distances_hmc_d1000_n10000_smed.csv")
