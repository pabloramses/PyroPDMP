...
for i in range(10):
    ...
    perCorrect_bk_d10_n1000_smed.append(percentage_correct(predmeder_bk_d10_n1000_smed,predUpper_bk_d10_n1000_smed,true_y_d10_n1000))
    distances_bk_d10_n1000_smed.append(torch.norm(postMean_bk_d10_n1000_smed - truePost.transpose(0,-1)))

    "Convergences"
    #k_bk_d10_n1000_smed = kernel_Stein_Discrepancies(bk_d10_n1000_smed, postSamp_bk_d10_n1000_smed)
    ...
    "Convergences"
    #ksd_bps_d10_n1000_smed = kernel_Stein_Discrepancies(bps_d10_n1000_smed, postSamp_bps_d10_n1000_smed)
    ...
    "Convergences"
    #ksd_zz_d10_n1000_smed = kernel_Stein_Discrepancies(zz_d10_n1000_smed, postSamp_zz_d10_n1000_smed)
    ...
    "Convergences"
    #ksd_hmc_d10_n1000_smed = kernel_Stein_Discrepancies(hmc_d10_n1000_smed, postSamp_hmc_d10_n1000_smed)
