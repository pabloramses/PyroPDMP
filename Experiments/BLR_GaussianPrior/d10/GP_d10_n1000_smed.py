...
r2scores_bk_d10_n1000_smed = []
perCorrect_bk_d10_n1000_smed = []
distances_bk_d10_n1000_smed = []
convergence_bk_d10_n1000_smed = []

r2scores_bps_d10_n1000_smed = []
perCorrect_bps_d10_n1000_smed = []
distances_bps_d10_n1000_smed = []
convergence_bps_d10_n1000_smed = []

r2scores_hmc_d10_n1000_smed = []
perCorrect_hmc_d10_n1000_smed = []
distances_hmc_d10_n1000_smed = []
convergence_hmc_d10_n1000_smed = []

r2scores_zz_d10_n1000_smed = []
perCorrect_zz_d10_n1000_smed = []
distances_zz_d10_n1000_smed = []
convergence_zz_d10_n1000_smed = []
...
for i in range(10):
    ...
    #################################BOOMERANG##################################
    "BOUND ON HESSIAN"
    Target_sigma_inv = torch.eye(dim) + (1/sigma_med**2) * torch.matmul(data_d10_n1000.transpose(0,-1), data_d10_n1000)
    hessian_bound = torch.linalg.matrix_norm(Target_sigma_inv).item()
    "REFERENCE MEASURE TUNING"
    Sigma_ref = torch.eye(dim)
    "DEFINITION OF SAMPLER"
    bk_d10_n1000_smed = Boomerang(model, Sigma=Sigma_ref, hessian_bound = hessian_bound, refresh_rate = 1, ihpp_sampler = 'Exact')
    mcmc_bk_d10_n1000_smed = MCMC(bk_d10_n1000_smed, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_bk_d10_n1000_smed.run(data_d10_n1000)
    "posterior distribution"
    postMean_bk_d10_n1000_smed = mcmc_bk_d10_n1000_smed.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_bk_d10_n1000_smed = mcmc_bk_d10_n1000_smed.get_samples()['beta']
    ...
    perCorrect_bk_d10_n1000_smed.append(percentage_correct(predLower_bk_d10_n1000_smed,predUpper_bk_d10_n1000_smed,true_y_d10_n1000))
    distances_bk_d10_n1000_smed.append(torch.norm(postMean_bk_d10_n1000_smed - truePost.transpose(0,-1)))

    "Convergences"
    k_bk_d10_n1000_smed = KSD(bk_d10_n1000_smed, postSamp_bk_d10_n1000_smed[-1000:,:])
    convergence_bk_d10_n1000_smed.append(k_bk_d10_n1000_smed)

    #######################################BPS########################################################
    "DEFINITION OF SAMPLER"
    bps_d10_n1000_smed = BPS(model, dimension=dim, hessian_bound = hessian_bound, refresh_rate = 1, ihpp_sampler = 'Exact')
    mcmc_bps_d10_n1000_smed = MCMC(bps_d10_n1000_smed, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_bps_d10_n1000_smed.run(data_d10_n1000)
    "posterior distribution"
    postMean_bps_d10_n1000_smed = mcmc_bps_d10_n1000_smed.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_bps_d10_n1000_smed = mcmc_bps_d10_n1000_smed.get_samples()['beta']
    ...
    "Convergences"
    ksd_bps_d10_n1000_smed = KSD(bps_d10_n1000_smed, postSamp_bps_d10_n1000_smed[-1000:,:])
    convergence_bps_d10_n1000_smed.append(ksd_bps_d10_n1000_smed)
    #######################################ZZ########################################################
    "DEFINITION OF SAMPLER"
    zz_d10_n1000_smed = ZZ(model, dimension=dim, Q = Target_sigma_inv, excess_rate = 0.25, ihpp_sampler = 'Exact')
    mcmc_zz_d10_n1000_smed = MCMC(zz_d10_n1000_smed, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_zz_d10_n1000_smed.run(data_d10_n1000)
    "posterior distribution"
    postMean_zz_d10_n1000_smed = mcmc_zz_d10_n1000_smed.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_zz_d10_n1000_smed = mcmc_zz_d10_n1000_smed.get_samples()['beta']
    ...
    "Convergences"
    ksd_zz_d10_n1000_smed = KSD(zz_d10_n1000_smed, postSamp_zz_d10_n1000_smed[-1000:,:])
    convergence_zz_d10_n1000_smed.append(ksd_zz_d10_n1000_smed)
    #######################################HMC########################################################
    "DEFINITION OF SAMPLER"
    hmc_d10_n1000_smed = NUTS(model)
    mcmc_hmc_d10_n1000_smed = MCMC(hmc_d10_n1000_smed, num_samples=num_samples, warmup_steps=warmup_steps)
    mcmc_hmc_d10_n1000_smed.run(data_d10_n1000)
    "posterior distribution"
    postMean_hmc_d10_n1000_smed = mcmc_hmc_d10_n1000_smed.get_samples()['beta'].mean(0)
    "get samples from predictive distribution"
    postSamp_hmc_d10_n1000_smed = mcmc_hmc_d10_n1000_smed.get_samples()['beta']
    ...
    "Convergences"
    ksd_hmc_d10_n1000_smed = KSD(hmc_d10_n1000_smed, postSamp_hmc_d10_n1000_smed[-1000:,:])
    convergence_hmc_d10_n1000_smed.append(ksd_hmc_d10_n1000_smed)

"to pandas bk"
r2scores_bk_d10_n1000_smed_df = pd.DataFrame(r2scores_bk_d10_n1000_smed)
...
convergence_bk_d10_n1000_smed_df = pd.DataFrame(convergence_bk_d10_n1000_smed)
"to csv bps"
...
convergence_bk_d10_n1000_smed_df.to_csv(PATH + "/results/d10_n100_smed/convergence_bk_d10_n1000_smed.csv")
...
convergence_bps_d10_n1000_smed_df = pd.DataFrame(convergence_bps_d10_n1000_smed)
"to csv bps"
...
convergence_bps_d10_n1000_smed_df.to_csv(PATH + "/results/d10_n100_smed/convergence_bps_d10_n1000_smed.csv")
...
convergence_zz_d10_n1000_smed_df = pd.DataFrame(convergence_zz_d10_n1000_smed)
"to csv bps"
...
convergence_zz_d10_n1000_smed_df.to_csv(PATH + "/results/d10_n100_smed/convergence_zz_d10_n1000_smed.csv")
...
convergence_hmc_d10_n1000_smed_df = pd.DataFrame(convergence_hmc_d10_n1000_smed)
"to csv bps"
...
convergence_hmc_d10_n1000_smed_df.to_csv(PATH + "/results/d10_n100_smed/convergence_hmc_d10_n1000_smed.csv")
