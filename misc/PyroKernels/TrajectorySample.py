...
class TrajectorySample():
    def __init__(self, kernel, skeleton, n_samples, ellipticQ=True):
        self.x_skeleton_dict = skeleton
        self.extract_keys_of_z(self.x_skeleton_dict)
        self.n = self.x_skeleton_dict[self.key_of_z[0]].shape[1]
    ...
    def ExtractSamples(self):
        x_skeleton = self.dict_of_tensors_to_numpy_V(self.x_skeleton_dict)
        T = self.t_skeleton[-1]
